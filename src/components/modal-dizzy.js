      ...
      <div className="modal">
        <div className="modal-header">
         ...
         <div className="modal-content">
          ...
          A project made with the framework Aframe. It is an interactive VR/webVR game with three levels. The theme of the game is dream or more specific a stress dream where the player is supposed to feel disorted and dizzy while trying to solve a task.<br/>
          ...
          <br/>
                ...
                <br/>
                <a className="proj-link" href="https://escapefromhyperisland.github.io/world-3/  ">View the whole game</a>   
          </p>
        </div>
      </div>
    </div>
