...
const About = () => {
  ...
  return (
   ...
   <div className="about">
    ...
    <br/>
    With a mentality that it is important to continue to learn thru your whole life, a passion for creativity and problem solving as well as having a interest in teambuilding and dynamics, I felt that I hit home when starting this journey on Hyper Island.
    <br/>
